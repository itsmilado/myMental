// src/features/transcription/pages/history/AppHistoryPage.tsx
...
- Inputs: one app-saved transcription row.
...
*/
    ...
    /*
- Builds the app-history Project filter options from currently loaded rows.
- Inputs: current app history list.
- Outputs: deduplicated Project labels for the app-history filter popover.
...
*/
    ...
    /*
- Builds the app-history Category filter options from currently loaded rows.
- Inputs: current app history list.
- Outputs: deduplicated Category labels for the app-history filter popover.
...
- Inputs: current app history list and applied local filters.
- Outputs: filtered app-saved transcription rows.
