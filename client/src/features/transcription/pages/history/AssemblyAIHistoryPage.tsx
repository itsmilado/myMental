// src/features/transcription/pages/history/AssemblyAIHistoryPage.tsx
...
import { fetchMyAssemblyConnections } from "../../../../api/authApi";
import {
    OnlineTranscription,
...
export const AssemblyAIHistoryPage = () => {
...
- Inputs: one AssemblyAI history row.
...
*/
    ...
    /*
- Builds Category options from the current AssemblyAI history rows.
...
*/
    ...
    /*
- Applies search, Project, Category, and date filters to the AssemblyAI history list.
- Inputs: current AssemblyAI rows and applied filter values.
- Outputs: filtered AssemblyAI transcription rows for the table and sidebar.
